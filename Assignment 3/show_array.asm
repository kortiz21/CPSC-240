...
;
;Purpose
;  This program will sort the 64-bit random numbers
;
;This file
...
beginLoop:  ; start loop
    cmp r13,r14
    je exitloop

    push qword 0
    mov rax,1
    mov rdi,format  ; format for hex and scientific notation
    mov rsi, [r15 + r13* 8]
    movsd xmm0, [r15 + 8*r13] ;convert to float before printing array
    call printf
    pop rax
